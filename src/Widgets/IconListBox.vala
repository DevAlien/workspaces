...
public class Workspaces.Widgets.IconListBox : Gtk.ListBox {
    ...
    public string ? get_selected_icon_name () {
        ...
        var icon_row = row as Workspaces.Widgets.IconRow;
        if (icon_row == null) {
            return null;
        }
    ...
    public void add_icon_name (string icon_name) {
        var row = new Workspaces.Widgets.IconRow (icon_name);
        add (row);
    ...
    private int sort_func (Gtk.ListBoxRow row1, Gtk.ListBoxRow row2) {
        var icon_row1 = row1 as Workspaces.Widgets.IconRow;
        if (icon_row1 == null) {
            return 0;
        }

        var icon_row2 = row2 as Workspaces.Widgets.IconRow;
        if (icon_row2 == null) {
            return 0;
        }
